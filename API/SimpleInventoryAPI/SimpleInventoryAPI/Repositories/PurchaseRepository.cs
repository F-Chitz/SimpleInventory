...
{
    public class PurchaseRepository : IBaseRespository<InventoryMove>
    {
        private readonly SimpleInventoryDbContext _context;

        public PurchaseRepository(SimpleInventoryDbContext context)
        {
            _context = context;
        }
        ...
        {
            Entity.MoveType = Data.InventoryMoveType.Purchase;
